...
$("#edit-global-input-1").val("Enter keyword");
$("#edit-global-input-1").focus(function(){if ($(this).val() == "Enter keyword"){$(this).val("");}});
$("#edit-global-input-1").blur(function(){if ($(this).val() == ""){$(this).val("Enter keyword");}});
$("#edit-submit-1").click(function(){if ($("#edit-global-input-1").val() == "Enter keyword"){$("#edit-global-input-1").val("");}});
});
...
jQuery.fn.sb = function(o) {
  ...
  $(this).each(function() {
    ...
    function loadSB() {
      ...
      $("body").append($sb);
      $display = $("<a href='#' class='display " + $orig.attr("class") + "'><span class='value'>" + $orig.val() + "</span> <span class='text'>" + o.displayFormat.call($orig.find("option:selected")[0], 0, 0) + "</span>" + o.arrowMarkup + "</a>");
      $sb.append($display);
      ...
      $orig.children().each(function(i) {
        if($(this).is("optgroup")) {
          ...
          $og.children("option").each(function(j) {
            var cmt = o.useCommentMarkup ? getComment(this) : undefined;
